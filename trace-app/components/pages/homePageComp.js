    ...
    return div([
        ...
        displayBox({},
            [h3('What is Trac³'),
             ...
             buttonComp('Javascript that looks like HTML',function(){__router.pageController.val = whatIsTrace})]
        ),
        spacer(),
        ...
        displayBox({},
            [h3('What Can Trac³ do?'),
             ...
             buttonComp('See what it looks like',()=>__router.pageController.val = whatIsTrace),
             ...
             buttonComp('Render Props',()=>__router.pageController.val = renderProps),
             ...
             buttonComp('Look at what a 300 line long tool can do',()=>__router.pageController.val = whatTraceCanDo),
            ]
        ),
        spacer(),
        displayBox({},[
            ...
            buttonComp('Learn Trac³',()=>__router.pageController.val = learnTrace)
        ]),
    ])
}
