    ...
    return div([
        ...
        displayBox({},
            [h3('What Can Trac³ do?'),
             ...
             buttonComp('See what it looks like',()=>__router.val = whatIsTrace),
             ...
             buttonComp('Render Props',()=>__router.val = renderProps),
             ...
             buttonComp('Look at what a 300 line long tool can do',()=>__router.val = whatTraceCanDo),
            ]
        ),
        spacer(),
        displayBox({},[
            ...
            buttonComp('Learn Trac³',()=>__router.val = learnTrace)
        ]),
    ])
}
